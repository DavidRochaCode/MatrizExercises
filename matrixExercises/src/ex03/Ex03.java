...
public class Ex03 {
	...
	public static void main(String[] args) {
		...
		for(int k = 0; k < matrizM[2].length; k++) {
			...
			}else if(matrizM[2][k]<maiorNumeroLinha) {
		...
		System.out.println("O maior número da linha 3 é "+maiorNumeroLinha+" e o menor número é " + menorNumeroLinha);
		System.out.println("O maior número da coluna 4 é "+maiorNumeroColuna+" e o menor número é " + menorNumeroColuna);
	}
